    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Online Courses</h3>
                <p class="mt-4 text-base text-gray-600">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface </p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Indoor Courses</h3>
                <p class="mt-4 text-base text-gray-600">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface </p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Amazing Library</h3>
                <p class="mt-4 text-base text-gray-600">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface </p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Exceptional Professors</h3>
                <p class="mt-4 text-base text-gray-600">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface </p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Top Programs</h3>
                <p class="mt-4 text-base text-gray-600">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface </p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Graduate Diploma</h3>
                <p class="mt-4 text-base text-gray-600">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface </p>
            </div>
