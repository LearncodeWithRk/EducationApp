  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-md mx-auto text-center">
            <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl">Popular Courses</h2>
            <p className="mt-4 text-base font-normal leading-7 text-gray-600">get a discount 50% discount until 1 January
</p>
        </div>
