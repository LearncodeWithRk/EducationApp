...
function Feature() {
  return (
    <section class="bg-gray-50 2xl:py-24 2xl:bg-gray-50">
    <div class="px-4 mx-auto bg-gray-50 max-w-7xl sm:px-6 lg:px-8 2xl:rounded-xl">
        <div class="py-10 sm:py-16 lg:py-24 2xl:pl-24">
            <div class="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20">
                <div class="lg:order-2 2xl:-mr-24">
                    <img class="w-full shadow-xl rounded-xl" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693646383/education%20img/dashboard-screenshot_dzrcbq.png" alt="" />
                </div>

                <div class="lg:order-1">
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-snug">Learn new skills online  <br class="hidden xl:block" />with top educators</h2>
                    ...
                    <ul class="grid grid-cols-1 mt-4 sm:mt-10 sm:grid-cols-2 gap-x-10 xl:gap-x-16 gap-y-4 xl:gap-y-6">
                        <li class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-black"> 120+ UI Design </span>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-black"> React with TailwindCSS </span>
                        </li>
                    ...
                    <div class="flex flex-col items-start mt-8 sm:space-x-4 sm:flex-row sm:items-center lg:mt-12">
                        ...
                        <a href="#" title="" class="inline-flex items-center justify-center px-4 py-4 mt-5 text-base font-semibold text-black transition-all duration-200 bg-transparent border border-black rounded-md sm:mt-0 hover:bg-blue-800 hover:text-black" role="button"> More View </a>
                    </div>
                </div>
            </div>
        </div>
