    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693647958/education%20img/Layer_1_ah2lwx.png" alt="" />

                <p class="text-base leading-relaxed text-gray-600 mt-7"> Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document </p>
