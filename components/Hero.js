        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <p className="mt-8 text-base text-black sm:text-xl">Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industrys </p>
                    ...
                    <div className="flex flex-col items-start mt-8 sm:space-x-4 sm:flex-row sm:items-center lg:mt-12">
                        ...
                        <Link href="#" title="" className="inline-flex items-center mt-6 text-base font-semibold transition-all duration-200 sm:mt-0 hover:opacity-80">
                ...
                <div>
                    <Image className="w-full" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693642417/education%20img/hero-img_z5pvri.png" alt="" width={1920} height={1920} />
                </div>
            </div>
        </div>
