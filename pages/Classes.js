...
function Classes() {
  return (
            ...
            <div className="bg-gradient-to-b from-[#f9fafb] relative to-[#f9fafb]">
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
                <div className="max-w-xl mx-auto text-center">
                    <h1 className="text-4xl font-bold sm:text-6xl">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-black to-black"> Best Courses 20+ Online for students </span>
                    </h1>
                    <p className="mt-5 text-base text-black sm:text-xl">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface</p>
                    ...
                    <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                        <div className="flex items-center">
                            ...
                            <p className="ml-3 text-sm text-black">Over 12,000 students joined</p>
                        </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <p className="ml-3 text-sm text-black">No yearly charges, maximum limits</p>
                        </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <p className="ml-3 text-sm text-black">Secured & safe online payment</p>
                        </div>
                    </div>
                </div>
            </div>
